...
describe('Auth Socket Handlers', () => {
  ...
  it('should return a server error during declining a private chat deletion request', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token2 },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal(
              'Server error during declining deletion request.'
            );
            clientSocket.disconnect();
            stub.restore();
            done();
  ...
  it('should return chat is not found or not private during confirming a private chat deletion request', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token2 },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal('Chat is not found or not private.');
            clientSocket.disconnect();
            done();
          }
        );
  ...
  it('should not allow user 3 to confirm a private chat deletion request because they are not a member of the private chat', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token3 },
      transports: ['websocket'],
    });
  ...
  it('should return recipient is not found during confirming a private chat deletion request', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token2 },
      transports: ['websocket'],
    });
  ...
  it('should return a server error during confirming a private chat deletion request', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token2 },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal(
              'Server error during private chat deletion confirmation.'
            );
            clientSocket.disconnect();
            stub.restore();
            done();
  ...
  it('should return this is not your notification if user tries to delete another user notification', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token2 },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', async ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal('This is not your notification.');
            clientSocket.disconnect();
            done();
          }
        );
