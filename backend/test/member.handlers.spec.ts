...
describe('Auth Socket Handlers', () => {
  ...
  it('should fail to remove a non-existing role', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
  ...
  it('should return chat is not found during deleting role', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
  ...
  it('should not allow user4 to delete the Removing-Role', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token4 },
      transports: ['websocket'],
    });
  ...
  it('should fail to delete the Owner role', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
  ...
  it('should return a server error during deleting role', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
  ...
  it('should fail to leave the private chat room', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal('You cannot leave a private chat.');
            clientSocket.disconnect();
            done();
          }
        );
  ...
  it('should leave the chat room', (done) => {
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.on('chatLeft', (response: typeof Chat) => {
          expect(response._id.toString()).to.equal(chat._id.toString());
          clientSocket.disconnect();
          done();
        });
  ...
  it('should not allow to become a member with incorrect ID', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token4 },
      transports: ['websocket'],
    });
  ...
  it('should not allow user4 to become a member of the chat room again', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token4 },
      transports: ['websocket'],
    });
  ...
  it('should return a server error during becoming a member of the chat room', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token4 },
      transports: ['websocket'],
    });
  ...
  it('should fail to transfer the ownership to user4 with an invalid chatId', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
  ...
  it('should fail to transfer the ownership to user5', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal('User is not a member of this chat.');
            clientSocket.disconnect();
            done();
          }
        );
  ...
  it('should not allow user to transfer the ownership to themselves', (done) => {
    const clientSocket = Client(address, {
      auth: { token: token },
      transports: ['websocket'],
    });
    ...
    clientSocket.on('connect', () => {
      ...
      clientSocket.on('roomJoined', ({ chatId }) => {
        ...
        clientSocket.emit(
          ...
          (err: { error: string }) => {
            expect(err.error).to.equal('User is already the owner.');
            clientSocket.disconnect();
            done();
          }
        );
